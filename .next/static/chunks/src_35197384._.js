...
"[project]/src/lib/waypoint.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sky$2d$mavis$2f$waypoint$2f$dist$2f$module$2f$web$2f$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sky-mavis/waypoint/dist/module/web/provider.js [app-client] (ecmascript)");
;
const waypointProvider = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sky$2d$mavis$2f$waypoint$2f$dist$2f$module$2f$web$2f$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WaypointProvider"].create({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$waypoint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/waypoint.ts [app-client] (ecmascript)");
;
;
;
...
const publicClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$clients$2f$createPublicClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPublicClient"])({
    chain: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$chains$2f$definitions$2f$saigon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saigon"],
...
const createSamurai = async (name)=>{
    ...
    const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$waypoint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["waypointProvider"].request({
...
const startBattle = async (opponent, betAmount)=>{
    ...
    const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$waypoint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["waypointProvider"].request({
        ...
        params: [
            {
                to: CONTRACT_ADDRESS,
                value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$parseEther$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseEther"])(betAmount),
                data: publicClient.encodeFunctionData({
                    abi: CONTRACT_ABI,
...
const getMinimumBet = async ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$formatEther$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatEther"])(minBet);
};
const getMaximumBet = async ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$formatEther$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatEther"])(maxBet);
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
...
function Home() {
    ...
    const [samurai, setSamurai] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [currentBattle, setCurrentBattle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [battleId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setContractAddress"])('0x0000000000000000000000000000000000000000');
        }
    }["Home.useEffect"], []);
    ...
    const checkConnection = async ()=>{
        const address = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$waypoint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getConnectedAddress"])();
        setConnectedAddress(address);
    };
    const loadBalance = async ()=>{
        if (!connectedAddress) return;
        try {
            const bal = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$waypoint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBalance"])(connectedAddress);
            setBalance(bal);
        } catch (error) {
    ...
    const loadSamurai = async ()=>{
        if (!connectedAddress) return;
        try {
            const samuraiData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSamurai"])(connectedAddress);
    ...
    const handleConnect = async ()=>{
        setLoading(true);
        try {
            const address = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$waypoint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["connectWallet"])();
            setConnectedAddress(address);
    ...
    const handleDisconnect = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$waypoint$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["disconnectWallet"])();
    ...
    const handleCreateSamurai = async ()=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSamurai"])(samuraiName);
    ...
    const handleUpgradeStat = async (stat)=>{
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["upgradeStat"])(stat);
    ...
    const handleStartBattle = async ()=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startBattle"])(opponentAddress, betAmount);
    ...
    const handleExecuteTurn = async ()=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["executeTurn"])(battleId);
            setMessage('Turn executed!');
            // Reload battle data
            const battleData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBattle"])(battleId);
...
_s(Home, "NLpYudlisOpgHEE6VfdQJ6nn6/o=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_35197384._.js.map